...
class AMPPPO(PPO):
    ...
    def collect_rollouts(
        ...
        if hasattr(env.unwrapped, "get_amp_observations"):
            self.amp_last_obs = env.unwrapped.get_amp_observations()
        else:
            raise Exception("env.unwrapped object does not exist get_amp_observations function!")

        n_steps = 0
        rollout_buffer.reset()
        self.amp_replay_buffer.reset()
        ...
        while n_steps < n_rollout_steps:
            ...
            if hasattr(env.unwrapped, "get_amp_observations"):
                amp_new_obs = env.unwrapped.get_amp_observations()
            else:
                raise Exception("env.unwrapped object does not exist get_amp_observations function!")
            ...
            amp_reward, d = self.discriminator.predict_amp_reward(self.amp_last_obs, amp_new_obs)
            total_rewards = amp_reward + rewards
