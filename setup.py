...
with open(os.path.join("stable_baselines3_ext", "version.txt")) as file_handler:
...
setup(
    name="stable_baselines3_ext",
    packages=[package for package in find_packages() if package.startswith("stable_baselines3_ext")],
